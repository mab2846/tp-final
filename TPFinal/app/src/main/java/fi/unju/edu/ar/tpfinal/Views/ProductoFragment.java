...
public class ProductoFragment extends Fragment {
    ...
    MenuPrincipalPresenter menuPrincipalPresenter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        MenuPrincipalInteractor menuPrincipalInteractor= new MenuPrincipalInteractorImp();

        adapterProducto=new AdapterProducto(lista);
